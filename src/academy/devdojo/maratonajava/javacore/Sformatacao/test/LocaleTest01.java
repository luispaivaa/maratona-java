...
public class LocaleTest01 {
    public static void main(String[] args) {
        ...
        DateFormat df5 = DateFormat.getDateInstance(DateFormat.FULL, localePortugal);
        ...
        System.out.println("Portugal " + df5.format(calendar.getTime()));


        System.out.println(localeItaly.getDisplayCountry(localeJapao));
        System.out.println(localeCH.getDisplayCountry(localePortugal));
